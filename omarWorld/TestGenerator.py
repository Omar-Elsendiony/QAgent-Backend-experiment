...
class TestGenerator:
    ...
    def InitializeTestChain(self, llm, fewshots=False):
    ...
    def createPromptStringGenerateTest(self, description, code, fewshots=False, test_cases_of_few_shot=None):
        if not fewshots:
    ...
    def queryGptGenerateTest(self, model, description, code, fewshots=False, test_cases_of_few_shot=None):
        prompt = self.createPromptStringGenerateTest(description, code, fewshots, test_cases_of_few_shot)
