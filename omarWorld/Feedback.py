...
class Feedback:
    ...
    *Given Code:*
    ...
    def InitializeFeedbackChain(self,llm):
    ...
    def createPromptStringFeedback(self, description, code, UnitTests, Feedback):
        prompt = RegenerateTestTemplate.format(description=description, code=code,UnitTests=UnitTests, Feedback=Feedback)
        return prompt


    def queryGptFeedback(self, model, description, code, UnitTests, Feedback):
        prompt = self.createPromptStringFeedback(description, code, UnitTests, Feedback)
